          ...
          <div className="bg-card rounded-2xl border border-border p-8 shadow-elevated">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-muted-foreground">
                Join shopUP for fast grocery delivery
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <ShopButton type="submit" variant="primary" size="lg" fullWidth>
                Create Account
            ...
            <div className="grid grid-cols-2 gap-4">
              <button className="flex items-center justify-center gap-2 px-4 py-3 rounded-xl border-2 border-border hover:border-primary/50 transition-colors">
